    ...
    <section id="about" className="container mx-auto px-6 py-12 mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-15">
        <p className="text-justify leading-relaxed">
          ...
          inovação e resolução de problemas. Atualmente, estou cursando o 3º
          semestre de Ciência da Computação e sou formado em Análise e
          Desenvolvimento de Sistemas (ADS). Concluí o curso do Instituto PROA e
          estou aprimorando meus conhecimentos em cloud computing na Escola da
          Nuvem. Minha última experiência foi como Analista de Suporte Técnico
